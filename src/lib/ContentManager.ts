...
const INITIAL_CONTENT: ContentData = {
  ...
  programs: [
    ...
    },
    {
      ...
      title: 'Bachelor Développement Fullstack', level: 'Bac+3', duration: '3 ans',
      ...
      fullDescription: "Formation full-stack complète : JavaScript/TypeScript, React, Node.js, SQL, MongoDB, Git et méthodes agiles. 100% alternance.",
    ...
    },
    {
      ...
      title: 'Bachelor Infrastructures Réseau Sécurisé', level: 'Bac+3', duration: '3 ans',
    ...
    },
    {
      ...
      title: 'Mastère Performance Énergétique', level: 'Bac+5', duration: '2 ans',
      ...
      fullDescription: "Mastère expert en audit énergétique, RE2020, BIM, énergies renouvelables et GTB/GTC pour piloter la transition énergétique. 100% alternance.",
